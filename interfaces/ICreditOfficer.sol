...
interface ICreditOfficer {
    ...
    // TODO: move to Lens
    function previewBorrowRatePerBlock(uint256 amount, bool repay)
        external
        view
        returns (uint256);
